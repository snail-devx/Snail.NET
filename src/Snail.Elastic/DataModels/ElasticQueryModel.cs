...
namespace Snail.Elastic.DataModels
{
    ...
    public sealed class ElasticBoolQueryModel : ElasticQueryModel, ISerializable
    {
        ...
        /// <summary>
        /// 查询子句必须全部成立；对应SQL的AND查询
        /// <para>和must一样，但不会影响计算score </para>
        /// </summary>
        ...
        /// Should 子句至少匹配几个
        /// <para>1、默认1； </para>
        /// <para>2、内部自动转数值；可给百分比；尽可能传数值，避免出现不可预知错误 </para>
        /// <para>3、对应ES中“minimum_should_match” </para>
        /// </summary>
    ...
    public sealed class ElasticWildcardQueryModel : ElasticQueryModel, ISerializable
    {
        ...
        /// 是否忽略大小写
        /// <para>1、默认false </para>
        /// <para>2、对应es的case_insensitive </para>
        /// </summary>
    ...
    public sealed class ElasticTermsSetQueryModel : ElasticQueryModel, ISerializable
    {
        ...
        /// <summary>
        /// 最小匹配数量字段
        /// <para>1、当前索引中存在的字段名称，取其值作为最小匹配数量值 </para>
        /// <para>2、对应es中“minimum_should_match_field” </para>
        /// </summary>
        /// <remarks>和<see cref="MinimumCount"/>二选一</remarks>
        public string? MinimumField { private init; get; }
        /// <summary>
        /// 最小匹配个数值
        /// <para>1、最小匹配个数值；必须大于1；否则没有意义 </para>
        /// <para>2、对应ES中“minimum_should_match_script”，自动生成固定值脚本；后续放开动态计算脚本 </para>
        /// </summary>
    ...
    public sealed class ElasticNestedQueryModel : ElasticQueryModel, ISerializable
    {
        ...
        /// <summary>
        /// nested字段中对象查询条件
        /// <para>1、字段需要加上【<see cref="Path"/>.】 </para>
        /// </summary>
        ...
        /// nested匹配字段得分计算模式
        /// <para>1、取值范围： </para>
        /// <para>- avg（默认）使用所有匹配子对象的平均相关性得分。 </para>
        /// <para>- max 使用所有匹配子对象的最高相关性分数。 </para>
        /// <para>- min 使用所有匹配子对象的最低相关性分数。 </para>
        /// <para>- none 不要使用匹配子对象的相关性分数。该查询为父文档分配一个分数0。 </para>
        /// <para>- sum 将所有匹配的子对象的相关性分数加在一起。 </para>
        /// <para>2、对应ES中“score_mode” </para>
        /// </summary>
        public string? ScoreMode { init; get; }
        /// <summary>
        /// 是否忽略Path为匹配的数据
        /// <para>1、false时，若path在文档中不存在，则会报错；true时，忽略错误 </para>
        /// <para>2、对应ES中“ignore_unmapped” </para>
        /// </summary>
    ...
    public sealed class ElasticHasChildQueryModel : ElasticQueryModel, ISerializable
    {
        ...
        /// <summary>
        /// 父包含的子文档个数最大值
        /// <para>1、超过此值父级文档则会从搜索结果中排除 </para>
        /// <para>2、对应ES的“max_children” </para>
        /// </summary>
        public int? MaxChildren { init; get; }
        /// <summary>
        /// 父包含的子文档个数最小值
        /// <para>1、小于此值父级文档则会从搜索结果中排除 </para>
        /// <para>2、对应ES的“min_children” </para>
        /// </summary>
    ...
    /// <summary>
    /// 不匹配任何数据查询
    /// <para>1、恒false查询条件 </para>
    /// <para>2、组装查询条件时，强制Name值为null </para>
    /// </summary>
    [Serializable]
