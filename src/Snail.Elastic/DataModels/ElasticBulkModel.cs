...
namespace Snail.Elastic.DataModels
{
    ...
    /// </summary>
    [Serializable]
    public abstract class ElasticBulkModel : ISerializable
    {
        #region 属性变量
        /// <summary>
        /// 批量操作名
    ...
    /// </summary>
    [Serializable]
    public sealed class ElasticBulkCreateModel : ElasticBulkModel, ISerializable
    {
        /// <summary>
        /// 构造方法
        /// </summary>
    ...
    /// </summary>
    [Serializable]
    public sealed class ElasticBulkSaveModel : ElasticBulkModel, ISerializable
    {
        /// <summary>
        /// 构造方法
        /// </summary>
    ...
    /// </summary>
    [Serializable]
    public sealed class ElasticBulkUpdateModel : ElasticBulkModel, ISerializable
    {
        /// <summary>
        /// 版本冲突时的重试次数，默认不重试
        /// </summary>
    ...
    /// </summary>
    [Serializable]
    public sealed class ElasticBulkDeleteModel : ElasticBulkModel, ISerializable
    {
        /// <summary>
        /// 构造方法
        /// </summary>
    ...
    /// </summary>
    [Serializable]
    public sealed class ElasticBuildUpdateScriptModel : ISerializable
    {
        /// <summary>
        /// 要执行的脚本Id
        /// </summary>
