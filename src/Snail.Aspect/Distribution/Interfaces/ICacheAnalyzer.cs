...
namespace Snail.Aspect.Distribution.Interfaces
{
    ...
    public interface ICacheAnalyzer
    {
        ...
        /// 缓存数据主Key
        /// </summary>
        /// <param name="masterKey">缓存主Key；详细参照：<see cref="Attributes.CacheMethodAttribute.MasterKey"/></param>
        ...
        /// 分析数据key值前缀
        /// </summary>
        /// <param name="dataKeyPrefix">数据key值前缀；详细参照：<see cref="Attributes.CacheMethodAttribute.DataKeyPrefix"/></param>
        /// <param name="parameters">外部传入的已有参数字典；key为参数名、value为具体参数值</param>
