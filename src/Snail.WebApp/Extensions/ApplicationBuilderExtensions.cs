...
namespace Snail.WebApp.Extensions
{
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        /// <param name="builder"></param>
        /// <returns></returns>
        public static IApplicationBuilder UseCookieAdapter(this IApplicationBuilder builder)
            => builder.UseMiddleware<CookieMiddleware>();
        /// <summary>
        /// 使用运行时上下文对象 <br />
        ///     1、为每个请求构建全新的运行时上下文，互不干扰
        /// </summary>
        /// <param name="builder"></param>
        /// <returns></returns>
        public static IApplicationBuilder UseRunContext(this IApplicationBuilder builder)
        {
