...
public class HttpAnalyzer : IHttpAnalyzer
{
    ...
    public virtual Task<string> AnalysisUrl(string url, IDictionary<string, object?>? parameters)
    {
        url = ParameterAnalyzer.DEFAULT.Analysis(url, parameters) ?? string.Empty;
