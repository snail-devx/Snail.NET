...
namespace Snail.Abstractions.Setting
{
    /// <summary>
    /// 应用程序配置信息管理器 <br />
    ///     1、管理环境变量；di、server等配置 <br />
    ///     2、基于【工作空间-资源编码】、【工作空间-项目-资源编码】格式遍历资源清单，基于Application.config作为清单文件入口 <br />
    /// </summary>
    public interface ISettingManager
    {
        ...
        /// <returns>配置内容，根据<paramref name="type"/>类型不一样，这里值不同<br />
        ///     1、<see cref="SettingType.File"/>：为文件的绝对路径<br />
        ///     2、<see cref="SettingType.Xml"/>：为xml内容字符串
        /// </returns>
